...
describe('TributacaoBr', function() {
	...
	describe('DEVE SER UM CPF VALIDO', function() {
		...
		it(`'${value}' validar o 'cpf' '${value}' must return '${expected}'`, function() {
	...
	describe('DEVE SER UM CNPJ VALIDO', function() {
		...
		it(`'${value}' validar o 'cnpj' '${value}' must return '${expected}'`, function() {
	...
	describe('DEVE SER UMA INSCRIÇÃO FEDERAL VALIDA - CPF', function() {
		...
		it(`'${value}' validar a 'inscrição federal:' '${value}' must return '${expected}'`, function() {
