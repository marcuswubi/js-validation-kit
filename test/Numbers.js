...
describe("Numbers", function() {
  describe("TO STRING", function() {
    const value = 2,
      expected = "2";
    it(`'${value}' deve retornar um dado do tipo string: '${expected}' `, function() {
  ...
  describe("IS INT", function() {
    const value = 42,
      expected = true;
    it(`'${value}' deve retornar '${expected}' para o teste de inteiro`, function() {
  ...
  describe("IS FLOAT", function() {
    const value = 42.5,
      expected = true;
    it(`'${value}' deve retornar '${expected}' para o teste de float`, function() {
  ...
  describe("IS POSITIVE", function() {
    const value = 42,
      expected = true;
    it(`'${value}' deve retornar '${expected}' para o teste de número positivo`, function() {
  ...
  describe("IS NEGATIVE", function() {
    const value = -42,
      expected = true;
    it(`'${value}' deve retornar '${expected}' para o teste de número negativo`, function() {
  ...
  describe("NUMBER TO WORD PT", function() {
    const value = 1,
      expected = "um";
    it(`'${value}' deve retornar '${expected}'`, function() {
  ...
  describe("NUMBER TO WORD PT", function() {
    const value = 6546785,
      expected =
        "seis milhões quinhentos e quarenta e seis mil setecentos e oitenta e cinco";
    it(`'${value}' deve retornar '${expected}'`, function() {
      assert.equal(Numbers.to_word_pt(value), expected);
    });
  });
  ...
  describe("NUMBER TO WORD PT - % PORCENTAGEM", function() {
    const value = 6546785,
      expected =
        "seis milhões quinhentos e quarenta e seis mil setecentos e oitenta e cinco porcento";
    it(`'${value}' deve retornar '${expected}'`, function() {
      assert.equal(Numbers.to_word_pt(value, "porcentagem"), expected);
    });
  });
  ...
  describe("NUMBER TO WORD PT - MONETARIO", function() {
    const value = 6546785,
      expected =
        "seis milhões quinhentos e quarenta e seis mil setecentos e oitenta e cinco reais";
    it(`'${value}' deve retornar '${expected}'`, function() {
      assert.equal(Numbers.to_word_pt(value, "monetario"), expected);
    });
  });
  ...
  describe("NUMBER TO WORD PT - MONETARIO", function() {
    const value = 1785.5,
      expected =
        "um mil setecentos e oitenta e cinco reais e cinquenta centavos";
    it(`'${value}' deve retornar '${expected}'`, function() {
      assert.equal(Numbers.to_word_pt(value, "monetario"), expected);
    });
  });
