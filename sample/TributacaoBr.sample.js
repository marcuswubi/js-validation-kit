...
console.log(color, 'IS FEDERAL NUMBER =', cpf, TributacaoBr.is_federal_number(cpf));
...
console.log(color, 'IS FEDERAL NUMBER =', cnpj, TributacaoBr.is_federal_number(cnpj));
