...
const Validations = {
    ...
    is_email_with_TLD: value => Validations.matchRegexp(value, regEx.EmailWithTLD),
    ...
    is_Number: value => Validations.matchRegexp(value, /^-?[0-9]\d*(\d+)?$/i),
    is_Float: value => Validations.matchRegexp(value, /^(?:[1-9]\d*|0)?(?:\.\d+)?$/i),
    is_Positive: (value) => (Validations.isNumber(value) || Validations.isFloat(value)) && value >= 0,
